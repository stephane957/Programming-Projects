...
describe('socketManager', () => {
    ...
    beforeEach(async () => {
        ...
        dictionaryServiceStub.gameDictionnary = {
    ...
    it('MouseEvent should call exchange button clicked', (done) => {
        ...
        clientSocket1.emit('onEchangerClick');
    ...
    it('MouseEvent should call leftlickSelection on leftlickSelection', (done) => {
        ...
        const stub = Sinon.stub(socketManager['mouseEventService'], 'leftlickSelection');

        clientSocket1.emit('leftlickSelection');
    ...
    // it("refreshBothDbs should emit that call the function that reset both leaderboards", () => {
    //     // const spy = Sinon.spy(dataBaseServiceStub as any, 'resetBothBestScoresCollection');
    //     clientSocket1.emit('RefreshBothDbs');
    //     setTimeout(() => {
    //         Sinon.assert.called(dataBaseServiceStub.resetBothBestScoresCollection);
    //     }, RESPONSE_DELAY);
    // })

    // it("should call call the getScoreClassic and getScoreLOG2990 when emitting 'dbReception'", () => {
    //     // const spy = Sinon.spy(socketManager as any, 'scoreClassic')
    //     // const mockPlayer = new Player('amir');
    //     // const mockPlayer2 = new Player('rayan');
    //     // dataBaseServiceStub.addScoreClassicToDb(mockPlayer);
    //     // dataBaseServiceStub.addScoreLog2990ToDb(mockPlayer2);
    //     clientSocket1.emit('dbReception');
    //     setTimeout(() => {
    //         expect(socketManager.scoreClassic).to.not.be.undefined;
    //         expect(socketManager.scoreLOG2990).to.not.be.undefined;
    //         // Sinon.assert.called(dataBaseServiceStub.bestScoreClassicCollection.getScoreClassic);
    //     })
    //     scoreStub.name = ["Amir"];
    //     scoreStub.score = "100";
    //     // socketManager.
