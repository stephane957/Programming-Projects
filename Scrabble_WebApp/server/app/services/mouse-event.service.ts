...
export class MouseEventService {
    ...
    leftlickSelection(player: Player, positionX: number): void {
    ...
    private clickIsInBoard(player: Player, position: Vec2) {
        ...
        if (
            realPosInBoardPx.x > 0 &&
            realPosInBoardPx.x < GlobalConstants.WIDTH_BOARD_NOBORDER &&
            realPosInBoardPx.y > 0 &&
            realPosInBoardPx.y < GlobalConstants.WIDTH_BOARD_NOBORDER
        ) {
