...
describe('PlayAreaService', () => {
    ...
    beforeEach(async () => {
        ...
        service = new PlayAreaService(standServiceStub, letterBankServiceStub, virtualPlayerStub, chatServiceStub, expertVPStub);
    ...
    // WHY DOES THAT FAIL ?
    // it('should fail to update old tile', () => {
    //     mockBoard[9] = new Array<Tile>();
    //     mockBoard[9][8] = new Tile();
    //     mockBoard[9][8].old = false;
    ...
    //     gameServerStub.board = mockBoard;
    //     service['updateOldTiles'](gameServerStub);
    //     expect(gameServerStub.board[8][9].old).to.equal(false);
    //     expect(gameServerStub.board[9][8].letter).to.equal(undefined);
    // });
