...
describe('MouseEventService', () => {
    ...
    it('leftlickSelection() should call sendStandToClient', () => {
        const value = 20;
        ...
        service.leftlickSelection(playerStubDefined, value);
    ...
    it('leftlickSelection() should not call sendStandToClient', () => {
        const value = 20;
