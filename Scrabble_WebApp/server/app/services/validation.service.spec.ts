...
describe('ValidationService', () => {
    ...
    it('lettersTouchH8Sqare should be called and return the correct error message', (done) => {
        gameServerStub.noTileOnBoard = true;
        sinon.stub(validator as any, 'lettersTouchH8Sqare').returns(false);
    ...
    it('lettersTouchH8Square funciton should return false if none of the letters of the word touches h8 the square', () => {
        expect(validator['lettersTouchH8Sqare']('bonjour', 'g5h')).to.equal(false);
        expect(validator['lettersTouchH8Sqare']('bonjour', 'g5v')).to.equal(false);
    });
