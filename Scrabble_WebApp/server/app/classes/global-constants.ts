...
export const NUMBER_SQARE_H_AND_W = 15;
export const WIDTH_LINE_BLOCKS = 4;
export const WIDTH_BOARD_NOBORDER = DEFAULT_WIDTH_BOARD - SIZE_OUTER_BORDER_BOARD * 2;
export const WIDTH_EACH_SQARE =
    (DEFAULT_HEIGHT_BOARD - SIZE_OUTER_BORDER_BOARD * 2 - (NUMBER_SQARE_H_AND_W - 1) * WIDTH_LINE_BLOCKS) / NUMBER_SQARE_H_AND_W;

export const NUMBER_SLOT_STAND = 7;
export const SIZE_OUTER_BORDER_STAND = 6;
export const DEFAULT_WIDTH_STAND = WIDTH_EACH_SQARE * NUMBER_SLOT_STAND + WIDTH_LINE_BLOCKS * (NUMBER_SLOT_STAND - 1) + SIZE_OUTER_BORDER_STAND * 2;
export const DEFAULT_HEIGHT_STAND = WIDTH_EACH_SQARE + SIZE_OUTER_BORDER_STAND * 2;
...
/// /////////////////////////////////////////////////////////////////////////
export const DATABASE_URL = 'mongodb+srv://Stephane:UserM0ng0@project-database.m7fal.mongodb.net/Project-Databse?retryWrites=true&w=majority';
export const DATABASE_NAME = 'Project-Database';
export const DATABASE_COLLECTION_DICTIONNARIES = 'Dictionnaries';
