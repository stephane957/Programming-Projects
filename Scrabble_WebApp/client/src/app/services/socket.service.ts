...
export class SocketService {
    ...
    private otherSocketOn() {
        ...
        this.socket.on('SendDictionnariesToClient', (dictionnaries: MockDict[]) => {
            this.infoClientService.dictionnaries = dictionnaries;
        });

        this.socket.on('DictionnaryDeletedMessage', (message: string) => {
            alert(message);
        });
