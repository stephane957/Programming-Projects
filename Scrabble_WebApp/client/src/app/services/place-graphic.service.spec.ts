...
describe('PlaceGraphicService', () => {
    ...
    const board: Tile[][] = [[]];
    for (
        let i = 0, l = GlobalConstants.SIZE_OUTER_BORDER_BOARD - GlobalConstants.WIDTH_EACH_SQARE - GlobalConstants.WIDTH_LINE_BLOCKS;
        i < GlobalConstants.NUMBER_SQARE_H_AND_W + 2;
        i++, l += GlobalConstants.WIDTH_EACH_SQARE + GlobalConstants.WIDTH_LINE_BLOCKS
    ) {
        board[i] = new Array<Tile>();
        for (
            let j = 0, k = GlobalConstants.SIZE_OUTER_BORDER_BOARD - GlobalConstants.WIDTH_EACH_SQARE - GlobalConstants.WIDTH_LINE_BLOCKS;
            j < GlobalConstants.NUMBER_SQARE_H_AND_W + 2;
            j++, k += GlobalConstants.WIDTH_EACH_SQARE + GlobalConstants.WIDTH_LINE_BLOCKS
        ) {
            ...
            newPosition.x1 = k;
            newPosition.y1 = l;
            newPosition.width = GlobalConstants.WIDTH_EACH_SQARE;
            newPosition.height = GlobalConstants.WIDTH_EACH_SQARE;
    ...
    it('should not call remove tile if the letterPos is not found or undefined', () => {
        ...
        drawingBoardServiceSpyObj.arrowPosY = 1;
        drawingBoardServiceSpyObj.arrowPosX = 2;
        // spyOn(service, 'findIndexLetterInStand').and.callThrough();
        infoClientServiceSpyObj.game.board = new Array<Tile[]>();
        infoClientServiceSpyObj.game.board[1] = new Array<Tile>();
        infoClientServiceSpyObj.game.board[2] = new Array<Tile>();
        infoClientServiceSpyObj.game.board[1][1] = tileStubDefined;
    ...
    it('should not call remove tile if the letterPos is not found or undefined', () => {
        ...
        // standServiceSpyObj['findIndexLetterInStand'].and.callFake(() => {
        //     return 0;
        // });
        // drawingServiceSpyObj.removeTile.and.callThrough();
    ...
    it('findIndexLetterInStand should return 0', () => {
        infoClientServiceSpyObj.player.stand = new Array<Tile>();
        infoClientServiceSpyObj.player.stand[0] = tileStubDefinedOld;
        // service['findIndexLetterInStand']('a', 0, infoClientServiceSpyObj.player)
        expect(service['findIndexLetterInStand']('a', 0, infoClientServiceSpyObj.player)).toBe(0);
    });
    it('findIndexLetterInStand should return 0', () => {
        infoClientServiceSpyObj.player.stand = new Array<Tile>();
        infoClientServiceSpyObj.player.stand[0] = tileStubDefinedOld;
        // service['findIndexLetterInStand']('a', 1, infoClientServiceSpyObj.player)
