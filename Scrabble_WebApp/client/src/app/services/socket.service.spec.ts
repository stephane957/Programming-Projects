...
describe('SocketService', () => {
    ...
    beforeEach(() => {
        ...
        infoClientServiceSpyObj.dictionnaries = new Array<MockDict>();
    ...
    it('DictionnaryDeletedMessage should alert given message', () => {
        const alertSpy = spyOn(window, 'alert');
        (service.socket as unknown as SocketMock).peerSideEmit('DictionnaryDeletedMessage', 'message');
        expect(alertSpy).toHaveBeenCalledWith('message');
    });
    ...
    it('sendDictionnariesToClient', () => {
        let mockDict: MockDict = { title: 'word', description: 'description' };
        (service.socket as unknown as SocketMock).peerSideEmit('SendDictionnariesToClient', [mockDict]);
        expect(infoClientServiceSpyObj.dictionnaries[0].title).toEqual(mockDict.title);
    });
