...
export class ParametresSelectionPageComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.mockDictionnary = { title: 'Dictionnaire français par défaut', description: 'Description de base' };
    }
    ...
    onClickDict(dictionnary: MockDict) {
        this.mockDictionnary = dictionnary;
    }
    ...
    createRoom() {
        ...
        } else if (this.infoClientService.gameMode === GlobalConstants.MODE_SOLO) {
        ...
        this.socketService.socket.emit('dictionnarySelected', this.mockDictionnary);
